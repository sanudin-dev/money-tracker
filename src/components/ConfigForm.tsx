...
import { GoogleIcon, INTEGRATION_META } from '@/components/icons'
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <form onSubmit={handleSaveWebhook} className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <h2 className="text-sm font-semibold text-zinc-900 dark:text-zinc-100 flex items-center gap-2">
            <INTEGRATION_META.webhook.Icon className="h-4 w-4" />
            {INTEGRATION_META.webhook.label}
          </h2>
          {config.webhook && (
      ...
      <form onSubmit={handleSaveSheets} className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <h2 className="text-sm font-semibold text-zinc-900 dark:text-zinc-100 flex items-center gap-2">
            <INTEGRATION_META.sheets.Icon className="h-4 w-4" />
            {INTEGRATION_META.sheets.label}
          </h2>
          {config.sheets && (
            <span className="rounded-full bg-green-100 px-2 py-0.5 text-xs font-medium text-green-700 dark:bg-green-900/30 dark:text-green-400">
              Active
      ...
      <form onSubmit={handleSaveNotion} className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <h2 className="text-sm font-semibold text-zinc-900 dark:text-zinc-100 flex items-center gap-2">
            <INTEGRATION_META.notion.Icon className="h-4 w-4" />
            {INTEGRATION_META.notion.label}
          </h2>
          {config.notion && (
            <span className="rounded-full bg-green-100 px-2 py-0.5 text-xs font-medium text-green-700 dark:bg-green-900/30 dark:text-green-400">
              Active
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <p className="text-xs text-zinc-400 dark:text-zinc-500">
            ...
            <strong className="text-zinc-600 dark:text-zinc-300">notion developer portal</strong>{' '}
