...
export const metadata = {
  ...
  description:
    'What Webhook and Sheets API each give you — both integrations can be active at the same time.',
}
    ...
    <div className="flex flex-col gap-8">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400">
          Two ways to push expenses to Google Sheets. Both can be active at the same time — every
          new expense is sent to all configured integrations.
        </p>
      </div>
      ...
      <Section title="What Sheets API gives you">
        ...
        <p className="mt-2">
          ...
          expire on a task counter, this is the right integration.
        </p>
        <p className="mt-2">
          It&apos;s also the only integration that supports{' '}
